  ...
  return (
    <div className=' flex flex-col'>
      ...
      >
        ...
        <NavLink to="/schemeApplication" className="no-underline" onClick={() => setSelectedScheme('Recurring Deposit')}>
          {imgWithLabel("/rd.png", "Recurring Deposit")}
        </NavLink>
        <NavLink to="/schemeApplication" className="no-underline" onClick={() => setSelectedScheme('Monthly Deposit')}>
          {imgWithLabel("/monthly.png", "Monthly Deposit")}
        </NavLink>
        </div>
        <div className='flex flex-row p-[64px] justify-center'>
        <NavLink to="/schemeApplication" className="no-underline"  onClick={() => setSelectedScheme('Fixed Deposit')}>
