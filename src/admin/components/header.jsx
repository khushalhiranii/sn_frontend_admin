  ...
  return (
    ...
    >
      ...
      <CustomInput placeholder="Search" iconSrc="/search.svg" className="p-[14px]" />
        <NavLink className="text-foundation-blue-normal active:bg-foundation-blue-normal active:text-white hover:bg-foundation-blue-normal hover:text-white focus:bg-foundation-blue-normal focus:text-white flex flex-row items-center justify-center p-[14px] gap-[12px] border-[2px] border-solid border-foundation-white-normal-hover rounded" to={'/admin/notifications'}>
          <Bell/>
        </NavLink>
