    ...
    <div className="overflow-y-auto flex flex-col items-start justify-start px-4 py-8 w-[calc(100%_-_344px)] text-left text-white font-inter mq850:max-w-full">
      <div className="flex flex-col items-center justify-center gap-6 w-full">
        ...
        <div className="flex flex-col items-start justify-start gap-2 w-full">
          ...
          <div className="flex flex-col items-start justify-start gap-2 w-full">
            <div className="tracking-tight leading-[150%] text-slate-800 font-semibold text-[20px] whitespace-pre-wrap mq450:text-[1rem] mq450:leading-[1.5rem]">Scheme Details</div>
            <div className="flex flex-row w-full items-start justify-between gap-4 text-[1rem] text-gray-400 font-roboto">
            ...
            <div className="flex flex-row w-full items-start justify-between gap-4 text-[1rem] text-gray-400 font-roboto">
            <InputComponent label={"Tenure"}  value={data.schemeInfo.Tenure}/>
            <InputComponent label={"Rate of Interest"} value={data.schemeInfo.Interest}/>
            <InputComponent label={"Maturity Date"} value={formatDate(data.schemeInfo.Maturity)}/>
            </div>
